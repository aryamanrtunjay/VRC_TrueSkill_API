...
import { type ClientOptions } from "./utils/client.js";
export { ClientOptions } from "./utils/client.js";
export declare function Client(options: ClientOptions): {
    api: import("./utils/client.js").Client;
    events: {
        search(query?: import("./generated/robotevents.js").operations["event_getEvents"]["parameters"]["query"], options?: Omit<RequestInit, "body" | "headers">): Promise<import("./utils/client.js").TransformedFetchResponse<{
            parameters: {
                query?: {
                    "id[]"?: number[];
                    "sku[]"?: string[];
        ...
        }, {}, "application/json", import("./wrappers/Event.js").Event[]>>;
        ...
        }, "application/json", import("./wrappers/Event.js").Event | null>>;
    };
    programs: {
        get(id: import("./types.js").ProgramCode, options?: Omit<RequestInit, "body" | "headers">): Promise<import("openapi-fetch").FetchResponse<{
            parameters: {
                query?: never;
                header?: never;
                path: {
            ...
            responses: {
                200: {
                    ...
                    content: {
                        "application/json": import("./generated/robotevents.js").components["schemas"]["Program"];
                    };
                };
            };
        }, {
            ...
            params: {
                path: {
                    id: import("./types.js").ProgramCode;
                };
            };
        }, "application/json">>;
        all(query?: import("./generated/robotevents.js").operations["program_getPrograms"]["parameters"]["query"], options?: Omit<RequestInit, "body" | "headers">): Promise<import("openapi-fetch").FetchResponse<{
            parameters: {
                query?: {
                    "id[]"?: number[];
                };
            ...
            responses: Omit<{
                200: {
                    ...
                    content: {
                        "application/json": import("./generated/robotevents.js").components["schemas"]["PaginatedProgram"];
                    };
                };
            }, 200> & {
                200: {
    ...
    seasons: {
        ...
        all(query?: import("./generated/robotevents.js").operations["season_getSeasons"]["parameters"]["query"], options?: Omit<RequestInit, "body" | "headers">): Promise<import("openapi-fetch").FetchResponse<{
            parameters: {
                query?: {
                    "id[]"?: number[];
                    "program[]"?: number[];
        ...
        events(id: number, query?: import("./generated/robotevents.js").operations["season_getEvents"]["parameters"]["query"], options?: Omit<RequestInit, "body" | "headers">): Promise<import("./utils/client.js").TransformedFetchResponse<{
            parameters: {
                query?: {
                    "sku[]"?: string[];
                    "team[]"?: number[];
    ...
    teams: {
        ...
        }, "application/json", import("./wrappers/Team.js").Team>>;
        search(query?: import("./generated/robotevents.js").operations["team_getTeams"]["parameters"]["query"], options?: Omit<RequestInit, "body" | "headers">): Promise<import("./utils/client.js").TransformedFetchResponse<{
            parameters: {
                query?: {
                    "id[]"?: number[];
                    "number[]"?: string[];
        ...
        getByNumber(number: string, program: import("./types.js").ProgramCode, options?: Omit<RequestInit, "body" | "headers">): Promise<import("./utils/client.js").TransformedFetchResponse<{
            parameters: {
                query?: {
                    "id[]"?: number[];
                    "number[]"?: string[];
        ...
        }, {}, "application/json", import("./wrappers/Team.js").Team | null>>;
    };
};
